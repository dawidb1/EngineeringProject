...
Projekt zosta³ zrealizowany w programie MATLAB. Jest to œrodowisko do wykonywania obliczeñ naukowych i in¿ynierskich, oraz do tworzenia symulacji komputerowych. (ref wiki) Do utworzenia graficznego interfejsu, u¿yto œrodowiska Appdesigner, który jest stosunkowo nowym narzêdziem programu MATLAB.
...
\subsection{Interfejsy i klasy}
Utworzono kilka interfejsów i klas, dla ³atwiejszego zarz¹dzania przep³ywem danych. Utworzono typy danych dla:
\begin{itemize}
\item Patient - zawiera wszystkie obliczone parametry pacjenta, oraz wyniki pierwszego badania fT4 i TRAb.
\item Dose - zawiera pola dla iloœci i czasu ustalonej dawki leczenia.
\item InitialValues - 4 wartoœci odpowiadaj¹ce warunkom pocz¹tkowym symulacji.
\item StabilityPoint - 4 wartoœci odpowiadaj¹ce punktom w przestrzeni, w których uk³ad osi¹ga stabilnoœæ.
\item StartData - wszystkie pola i struktury potrzebne do startu aplikacji.
\item Simulation - wszystkie pola i struktury potrzebne do rozpoczêcia symulacji.
\item SimulationResult - wszystkie pola i struktury potrzebne do wyœwietlenia wyników symulacji.
\end{itemize}
...
\subsection{Przep³yw danych w aplikacji}
...
Na diagramach przedstawiono informacje, które przechowuj¹ obiekty je implementuj¹ce.
\begin{figure}
	\centering
