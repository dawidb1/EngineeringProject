...
1. Analiza modelu
2. Obliczenia
    a. Wzory punktu stacjonarnego
    b. Ręczne obliczenie macierzy Jacobiego (pochodne cząstkowe)
    c. Wektory i wartości własne
    d. Przewidywanie granicy funkcji modelu
    e. Symbol Newtona
